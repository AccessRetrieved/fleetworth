...
- Target 1.5 Mbps for session video. Automatically finalize at five recorded minutes or 80 MiB of chunks; keep all captured photos. Show recording size in review and validate file sizes before sending (10 MiB/photo, 256 MiB/video, 326 MiB combined). Never silently drop or truncate a session recording to pass an upload limit.
